<template>
    <div class="panel-heading clearfix">
        ...
        <div class="text-right pull-right" v-cloak>
            <button class="btn btn-default" v-link="{ name: 'language_create' }">
...
<script>
    export default {
            ...
            return {
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        name: 'priority',
                        sortField: 'priority',
                        titleClass: 'text-center th-priority',
                        dataClass: 'text-center',
                    },
                    {
                        title: 'Created',
        ...
        events: {
            ...
            'editData'(rowData) {
                this.$route.router.go({ name: 'language_edit', params: { languageId: rowData.id } })
            },
            'deleteData'(rowData) {
                swal({
                    title: 'Confirmation',
